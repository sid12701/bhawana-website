...
export const grievanceRedressalSections: GrievanceSection[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      {"type": "paragraph", "text": "Level 18, One Horizon Centre, DLF Phase 5, Gurugram – 122002"},
