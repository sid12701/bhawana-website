...
const doc: BoardPolicyDocument = {
  ...
  sections: [
  {
    ...
    blocks: [
        ...
        { type: "paragraph", text: "Customers shall be informed of avenues to escalate their complaints/grievances within the organization and their rights to alternative remedy, if they are not fully satisfied with the response of the company to their complaints." },
  ...
  {
    id: "grounds-for-filing-a-complaint",
    ...
    blocks: [
        ...
        { type: "paragraph", text: "Non-observance of directions issued by RBI to NBFCs," },
        { type: "paragraph", text: "Non-adherence to any of the provisions of RBI guidelines on Fair Practices Code, issued from time to time." },
  ...
  {
    id: "3-2-content-information-in-complaints",
    title: "3.2 Content / information in Complaints",
    blocks: [
        ...
        { type: "paragraph", text: "Customer’s full name" },
        { type: "paragraph", text: "Registered mobile number of the Customer in working condition" },
  ...
  {
    id: "complaint-lodge-registration",
    title: "Complaint lodge / registration",
    blocks: [
  ...
  {
    id: "resolution-of-grievances",
    title: "Resolution of Grievances",
    blocks: [
  ...
  {
    id: "5-treatment-of-complaints-grievances-enquiries-etc",
  ...
  {
    id: "7-3-statutory-reporting",
    title: "7.3 Statutory Reporting",
    blocks: [
