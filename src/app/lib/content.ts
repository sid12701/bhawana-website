...
export const legal = {
    ...
    interestRatePdf: "/policies/interest-rate-policy.pdf",
    kycAmlCftPdf: "/policies/kyc-aml-cft-policy.pdf",
    ...
    kycAmlCftPage: "/kyc-aml-cft-policy/",
  ...
  export const navigation = {
    main: [
      ...
      },
      {
        ...
        href: "#",
        children: [
          { label: "Interest Rate Policy", href: legal.interestRatePage },
          { label: "KYC-AML-CFT Policy", href: legal.kycAmlCftPage },
          { label: "Fair Practice Code (English)", href: legal.fpcPage },
          { label: "Fair Practice Code (Hindi)", href: legal.fpcHindiPage },
          { label: "Grievance Redressal Mechanism", href: legal.grievancePage },
